...
public class Shad3dia extends JFrame implements ActionListener {
			...
			if (e.getSource() == b2) {
				...
				if (a > 0 && a <= 5 && b >= 0 && b <= 200) {
					...
					if (a <= ShadSc3.d) {
						...
						Shad3Atmd Shad3atd = new Shad3Atmd();
						super.dispose();

					}
					if (a > ShadSc3.d) {
						JOptionPane.showMessageDialog(this, "Seat not available only " + ShadSc3.d + " seat left");
