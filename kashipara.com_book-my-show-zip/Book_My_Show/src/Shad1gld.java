...
public class Shad1gld extends JFrame implements ActionListener {
			...
			if (e.getSource() == b2) {
				...
				if (a > 0 && a <= 20 && b >= 0 && b <= 200) {
					...
					if (a <= ShadSc.g) {
						...
						Shad1Atmg shad1atg = new Shad1Atmg();
					
						super.dispose();

					}
					if (a > ShadSc.g) {
						JOptionPane.showMessageDialog(this, "Seat not available only " + ShadSc.g + " seat left");
