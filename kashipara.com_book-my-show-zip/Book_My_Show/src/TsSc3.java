...
public class TsSc3 extends JFrame implements ActionListener{
	...
	public TsSc3() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from ts3 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from ts3 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from ts3 where seat_type=?");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Ts3gld ts3g = new Ts3gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Ts3dia ts3d = new Ts3dia();
			super.dispose();
		}
