...
public class Shad2payd extends JFrame implements ActionListener {
	...
	public Shad2payd() {
		...
		l9=  new JLabel("Shadi Mei Zoror Ana");
		...
		l14=  new JLabel(Shad2dia.s1);
		l14.setBounds(250, 160, 200, 25);
		super.add(l14);
		 
		l15=  new JLabel(Shad2dia.s2);
