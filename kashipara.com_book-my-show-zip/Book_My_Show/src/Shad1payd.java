...
public class Shad1payd extends JFrame implements ActionListener {
	...
	public Shad1payd() {
		...
		l9=  new JLabel("Shadi mei zaor ana");
		l9.setBounds(280, 10, 250, 25);
		super.add(l9);
		l9.setFont(font);
		
		l10=  new JLabel("12-3");
		l10.setBounds(280, 40, 200, 25);
		super.add(l10);
		l10.setFont(font);
		
		l11=  new JLabel(Sign_in.name);
		l11.setBounds(280, 70, 200, 25);
		super.add(l11);
		l11.setFont(font);
		
		l12=  new JLabel(Sign_in.email);
		l12.setBounds(280, 100, 200, 25);
		super.add(l12);
		l12.setFont(font);
		
		l13=  new JLabel(Sign_in.mob);
		l13.setBounds(280, 130, 200, 25);
		super.add(l13);
		l13.setFont(font);
		
		l14=  new JLabel(Shad1dia.s1);
		l14.setBounds(280, 160, 200, 25);
		super.add(l14);
		l14.setFont(font); 
		
		l15=  new JLabel(Shad1dia.s2);
		l15.setBounds(280, 190, 200, 25);
		super.add(l15);
		l15.setFont(font);
		
		l16=  new JLabel("Diamond");
		l16.setBounds(280, 220, 200, 25);
		super.add(l16);
		l16.setFont(font);
		
		l17=  new JLabel(Shad1dia.cos);
		l17.setBounds(280, 250, 200, 25);
		super.add(l17);
		l17.setFont(font);
