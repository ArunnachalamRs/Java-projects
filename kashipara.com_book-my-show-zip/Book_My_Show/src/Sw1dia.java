...
public class Sw1dia extends JFrame implements ActionListener {
			...
			if (e.getSource() == b2) {
				...
				if (a > 0 && a <= 5 && b >= 0 && b <= 200) {
					...
					if (a <= SwSc.d) {
						...
						Sw1Atmd Sw1atd = new Sw1Atmd();
						super.dispose();

					}
					if (a > SwSc.d) {
						JOptionPane.showMessageDialog(this, "Seat not available only " + SwSc.d + " seat left");
