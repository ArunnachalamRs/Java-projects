...
public class Ts2payd extends JFrame implements ActionListener {
	...
	public Ts2payd() {
		...
		l14=  new JLabel(Ts2dia.s1);
		l14.setBounds(250, 160, 200, 25);
		super.add(l14);
		 
		l15=  new JLabel(Ts2dia.s2);
