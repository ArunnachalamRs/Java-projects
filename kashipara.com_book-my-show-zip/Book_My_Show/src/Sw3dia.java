...
public class Sw3dia extends JFrame implements ActionListener {
			...
			if (e.getSource() == b2) {
				...
				if (a > 0 && a <= 5 && b >= 0 && b <= 200) {
					...
					if (a <= SwSc3.d) {
						...
						Sw3Atmd Sw3atd = new Sw3Atmd();
						super.dispose();

					}
					if (a > SwSc3.d) {
						JOptionPane.showMessageDialog(this, "Seat not available only " + SwSc3.d + " seat left");
