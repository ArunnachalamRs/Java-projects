...
public class TsSc2 extends JFrame implements ActionListener{
	...
	public TsSc2() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from ts2 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from ts2 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from ts2 where seat_type=?");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Ts2gld ts2g = new Ts2gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Ts2dia ts2d = new Ts2dia();
			super.dispose();
		}
		if (e.getSource()==back){
