...
public class Shad2dia extends JFrame implements ActionListener {
	JLabel l1, l2, l3, l4 ;
	float cost = 0;
	float tc = 0, sc = 0;
			...
			if (e.getSource() == b2) {
				...
				if (a > 0 && a <= 5 && b >= 0 && b <= 200) {
					...
					if (a <= ShadSc2.d) {
						...
						Shad2Atmd Shad2atd = new Shad2Atmd();
						
						super.dispose();

					}
					if (a > ShadSc2.d) {
						JOptionPane.showMessageDialog(this, "Seat not available only " + ShadSc2.d + " seat left");
