...
public class ShadSc2 extends JFrame implements ActionListener{
	...
	public ShadSc2() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from shaad2 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from shaad2 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from shaad2 where seat_type=?");
		...
		l[6]= new JLabel("Movie  :  Shadi mei zror ana");
		l[6].setBounds(30, 210, 200, 30);
		super.add(l[6]);
		
		
		l[7]= new JLabel("Show time   : 3-6");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Shad2gld shd2g = new Shad2gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Shad2dia shd2d = new Shad2dia();
			super.dispose();
		}
		if (e.getSource()==back){
