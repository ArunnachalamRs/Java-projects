...
public class Shad1pays extends JFrame implements ActionListener {
	...
	public Shad1pays() {
		...
		l9=  new JLabel("Shadi Mei Zaror Ana");
		...
		l14=  new JLabel(Shad1sil.s1);
		l14.setBounds(280, 160, 200, 25);
		super.add(l14);
		 
		l15=  new JLabel(Shad1sil.s2);
