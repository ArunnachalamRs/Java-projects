...
public class ShadSc3 extends JFrame implements ActionListener{
	...
	public ShadSc3() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from shaad3 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from shaad3 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from shaad3 where seat_type=?");
		...
		l[6]= new JLabel("Movie  :  shadi mei zaor ana");
		l[6].setBounds(30, 210, 200, 30);
		super.add(l[6]);
		
		
		l[7]= new JLabel("Show time   : 6-9");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Shad3gld Shad3g = new Shad3gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Shad3dia shd3d = new Shad3dia();
			super.dispose();
		}
		if(e.getSource()==back){
