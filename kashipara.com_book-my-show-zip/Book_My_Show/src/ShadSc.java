...
public class ShadSc extends JFrame implements ActionListener{
	...
	public ShadSc() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from shaad1 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from shaad1 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from shaad1 where seat_type=?");
		...
		l[6]= new JLabel("Movie  :  Shaddi mei zaror ana");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Shad1gld shd1g = new Shad1gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Shad1dia shd1d = new Shad1dia();
			super.dispose();
		}
		if (e.getSource()==back){
