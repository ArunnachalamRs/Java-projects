...
public class SwSc3 extends JFrame implements ActionListener{
	...
	public SwSc3() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from sw3 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from sw3 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from sw3 where seat_type=?");
		...
		l[6]= new JLabel("Movie  :  Star Wars");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Sw3gld sw3g = new Sw3gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Sw3dia sw3d = new Sw3dia();
			super.dispose();
		}
		if (e.getSource()==back){
			SwSt sw = new SwSt();
