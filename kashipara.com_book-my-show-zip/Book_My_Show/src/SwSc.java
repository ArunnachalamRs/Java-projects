...
public class SwSc extends JFrame implements ActionListener{
	...
	public SwSc() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from sw1 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from sw1 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from sw1 where seat_type=?");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Sw1gld sw1g = new Sw1gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Sw1dia sw1d = new Sw1dia();
			super.dispose();
		}
		if (e.getSource()==back){
