...
public class Sw3payd extends JFrame implements ActionListener {
	...
	public Sw3payd() {
		...
		l14=  new JLabel(Sw3dia.s1);
		l14.setBounds(250, 160, 200, 25);
		super.add(l14);
		 
		l15=  new JLabel(Sw3dia.s2);
