...
public class Ts3dia extends JFrame implements ActionListener {
			...
			if (e.getSource() == b2) {
				...
				if (a > 0 && a <= 5 && b >= 0 && b <= 200) {
					...
					if (a <= TsSc3.d) {
						...
						Ts3Atmd ts3atd = new Ts3Atmd();
						super.dispose();

					}
					if (a > TsSc3.d) {
						JOptionPane.showMessageDialog(this, "Seat not available only " + TsSc3.d + " seat left");
