...
public class SwSc2 extends JFrame implements ActionListener{
	...
	public SwSc2() {
		...
		try {
			...
			PreparedStatement ps1 = con.prepareStatement("select * from sw2 where seat_type=?");
			...
			PreparedStatement ps2 = con.prepareStatement("select * from sw2 where seat_type=?");
			...
			PreparedStatement ps3 = con.prepareStatement("select * from sw2 where seat_type=?");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b2){
			...
			Sw2gld sw2g = new Sw2gld();
			super.dispose();
		}
		
		if(e.getSource()==b3){
			
			Sw2dia sw2d = new Sw2dia();
			super.dispose();
		}
		if (e.getSource()==back){
			SwSt sw = new SwSt();
